...
var dialog = {exports: {}};/* Injected with object hook! */
...
var jumpToLine = {exports: {}};/* Injected with object hook! */

var hasRequiredJumpToLine;
...
function requireJumpToLine () {
	...
	(function (module, exports) {
		...
		(function(mod) {
		  mod(requireCodemirror(), requireDialog());
		})(function(CodeMirror) {
...
var search = {exports: {}};/* Injected with object hook! */

var searchcursor = {exports: {}};/* Injected with object hook! */
...
async function calculateDiffWithWorker(left, right) {
  if (!diffWorker) {
    diffWorker = wrap(
      new Worker(new URL(/* @vite-ignore */ ""+new URL('diff.worker-C2f3jC8j.js', import.meta.url).href+"", import.meta.url), {
        type: "module"
      })
    );
  }
